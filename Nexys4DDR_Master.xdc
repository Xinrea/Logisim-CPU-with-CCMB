...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets in_IR_IBUF[1]];
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets in_IR_IBUF[2]];
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets in_IR_IBUF[3]];
