...
# set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pro_reset_IBUF[0]];
# set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pro_reset_IBUF[1]];
# set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pro_reset_IBUF[2]];
...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { changef }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { in_RST }]; #IO_L9P_T1_DQS_14 Sch=btnc
# set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { in_IR[1] }]; #IO_L4N_T0_D05_14 Sch=btnu
# set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { in_IR[0] }]; #IO_L12P_T1_MRCC_14 Sch=btnl
# set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { in_IR[2] }]; #IO_L10N_T1_D15_14 Sch=btnr
# set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { in_IR[3] }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
